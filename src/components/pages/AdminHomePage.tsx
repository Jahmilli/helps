...
import AdminWorkShopReportContainer from '../containers/AdminDashboard/AdminWorkShopReportContainer';
    ...
    return (
        <div>
            ...
            <div>
                ...
                <Route path={`${path}/reports/workshops`} render={(props) => <AdminWorkShopReportContainer {...props} />} />
